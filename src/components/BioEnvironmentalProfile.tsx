      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-5 gap-16 relative z-10">
          ...
          <div className="lg:col-span-2 lg:sticky lg:top-[150px] lg:self-start">
            <div className="mb-6">
              <span className="inline-block px-4 py-2 text-xs font-semibold text-[#002DFF] bg-[#002DFF]/10 rounded-full uppercase tracking-wider">
            ...
            {/* Benefits Callout */}
            <div className="bg-gradient-to-br from-[#F7F8FA] to-white border-l-4 border-[#002DFF] p-6 rounded-r-lg shadow-sm">
              <h3 className="text-sm font-bold text-[#1A1A1A] uppercase tracking-wide mb-3">Why Survey Before Buying?</h3>
              <ul className="space-y-2 text-sm text-[#6B7280]">
                <li className="flex items-start space-x-2">
                  <svg className="w-4 h-4 text-[#002DFF] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="lg:col-span-3 space-y-6">
            {/* Atmospheric Purity */}
            <div className="bg-gradient-to-br from-white to-[#F7F8FA] rounded-xl p-8 shadow-md border-2 border-gray-100 hover:border-[#002DFF]/30 hover:shadow-xl transition-all group">
              <div className="flex items-start space-x-6">
                <div className="flex-shrink-0">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#002DFF]/10 to-[#4D7FFF]/10 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                    <svg className="w-8 h-8 text-[#002DFF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex-1">
                  ...
                  <a href="/atmospheric-purity-diagnostic" className="inline-flex items-center text-sm font-semibold text-[#002DFF] hover:text-[#1A1A1A] transition-colors">
            ...
            <div className="bg-gradient-to-br from-white to-[#F7F8FA] rounded-xl p-8 shadow-md border-2 border-gray-100 hover:border-[#002DFF]/30 hover:shadow-xl transition-all group">
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <a href="/hydration-integrity-diagnostic" className="inline-flex items-center text-sm font-semibold text-[#002DFF] hover:text-[#1A1A1A] transition-colors">
                    Learn More About Testing
                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
            ...
            <div className="bg-gradient-to-br from-white to-[#F7F8FA] rounded-xl p-8 shadow-md border-2 border-gray-100 hover:border-[#002DFF]/30 hover:shadow-xl transition-all group">
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <a href="/electromagnetic-hygiene-diagnostic" className="inline-flex items-center text-sm font-semibold text-[#002DFF] hover:text-[#1A1A1A] transition-colors">
                    Learn More About Testing
                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
            ...
            <div className="bg-gradient-to-br from-white to-[#F7F8FA] rounded-xl p-8 shadow-md border-2 border-gray-100 hover:border-[#002DFF]/30 hover:shadow-xl transition-all group">
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <a href="/circadian-alignment-diagnostic" className="inline-flex items-center text-sm font-semibold text-[#002DFF] hover:text-[#1A1A1A] transition-colors">
                    Learn More About Testing
                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
            ...
            <div className="bg-gradient-to-br from-white to-[#F7F8FA] rounded-xl p-8 shadow-md border-2 border-gray-100 hover:border-[#002DFF]/30 hover:shadow-xl transition-all group">
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <a href="/material-toxicity-diagnostic" className="inline-flex items-center text-sm font-semibold text-[#002DFF] hover:text-[#1A1A1A] transition-colors">
                    Learn More About Testing
                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
